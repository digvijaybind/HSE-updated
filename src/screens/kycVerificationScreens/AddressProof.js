...
export default function AddressProof({navigation}) {
 ...
 <View style={style(darkMode).container} >
    ...
    <View style={style().innerContainer}>
       <CustomText topic={'Address Proof'} color={darkMode?darkColors.text.secondary:lightColors.text.secondary} fontSize={30} fontWeight={'bold'}/>
    <View style={style().container2}>
            <Image tintColor={lightColors.icon.primary} source={require('../../assets/images/upload.png')}/>
            <CustomText customStyle={{textAlign:'center'}} color={lightColors.text.grey} fontWeight={"normal"} fontSize={18} topic={'Take a photo or Upload your Passport'}/>
      </View>
