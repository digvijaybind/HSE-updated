...
export default function QuestionAnswerCards({question,answer}) {
   ...
   <View style={style().card}>
     <View style={style().innerCard}>
       <CustomText topic={question} color={lightColors.text} fontSize={20} fontWeight={'bold'}/>
     ...
     <CustomText topic={answer} color={lightColors.text} fontSize={20} fontWeight={'normal'}/>
     </View>
     }
   </View>
  )
